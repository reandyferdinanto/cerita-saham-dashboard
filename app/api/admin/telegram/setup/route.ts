...
import { clearTelegramSettings, getTelegramSettings, updateTelegramSettings } from "@/lib/data/telegramSettings";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (!botToken && adminChatId === undefined && adminThreadId === undefined) {
